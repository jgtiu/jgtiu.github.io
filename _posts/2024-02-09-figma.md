...
Figma's online collaborative whiteboard FigJam came out with new [AI features](https://www.figma.com/blog/introducing-ai-to-figjam/) last November 2023. The new features take the grunt work out of team meetings by automating these common meeting tasks:
...
<figure>
    ...
    <figcaption>Figma's new AI features. Source: <a href="https://www.figma.com/blog/introducing-ai-to-figjam/">Figma Blog</a>.</figcaption>
</figure>

## What's this post for?

Whenever a software tool releases new features, the data/product teams behind them often study user behaviors and extract patterns from them to improve the new features or the overall product. Here I wear a product data scientist's hat to show how I currently think about measuring the effectiveness of the new AI features.
...
To get the full code used for this post, check out this [Colab notebook](https://colab.research.google.com/drive/1Xox2mLClfBqZR0Y04KR783XuziANfGJp).
{: .notice}

## Fake data

I don't work at Figma, so I generated fake and random usage data in lieu of the real thing to show what it might look like (I used the [Faker](https://faker.readthedocs.io/en/master/) Python package to do this). Of course, there's always room to make it more realistic!
...
Figma [collects each user's email and job title](https://www.figma.com/blog/how-we-use-data/) when they sign up.
...
[Colab notebook](https://colab.research.google.com/drive/1Xox2mLClfBqZR0Y04KR783XuziANfGJp)

## References
1. [From experiment to launch: how data shaped a new comments experience \| Figma Blog](https://www.figma.com/blog/from-experiment-to-launch-how-data-shaped-a-new-comments-experience/)
2. [How Figma’s data science and user research teams weave together insights that count \| Figma Blog](https://www.figma.com/blog/cross-functional-data-science-user-research-figma/)
3. [How we use data \| Figma Blog](https://www.figma.com/blog/how-we-use-data/)
4. [Introducing AI to FigJam \| Figma Blog](https://www.figma.com/blog/introducing-ai-to-figjam/)
5. [What and Why, How to Leverage Data Science and Research - Christa S, Clancy S (Config 2022) - YouTube](https://www.youtube.com/watch?v=qE82-gndBRE)
